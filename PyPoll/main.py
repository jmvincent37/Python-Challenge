...
#set path
pypoll_csv = os.path.join('/Users/jennifervincent/M3Challenge','election_data.csv')
...
#double check my variable assignments
type(candidates), type(num_votes),type(vote_counts),type(percentages),type(max_votes),type(max_index)
